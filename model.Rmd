...
model_5_data <- nfl_data_set %>% 
  ...
  dplyr::select(point_differential, season, week,
                ...
                off_passing_yards_qtr_4_home_5w_avg, off_passing_yards_qtr_5_home_5w_avg, off_rushing_yards_qtr_1_home_5w_avg, 
                off_rushing_yards_qtr_2_home_5w_avg, off_rushing_yards_qtr_3_home_5w_avg, off_rushing_yards_qtr_4_home_5w_avg, off_rushing_yards_qtr_5_home_5w_avg) %>% 
  dplyr::collect()
```
