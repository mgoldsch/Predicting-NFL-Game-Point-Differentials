...
#dm <- fre_dm
tic()
runs <- do_bayes(n_design = 30, of = obj.fun, opt_steps = 10, seed = 123456) #will need to change n_design when more hyparameters are added
toc()
```
